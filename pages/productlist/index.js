...
const mockProducts = [
  {
    ...
    sales: 156,
    status: 0, // 正常
    image: 'https://img.alicdn.com/imgextra/i3/2206686532409/O1CN01AtlLxk1TfMrV32j1A_!!2206686532409-0-sm.jpg',
  ...
  },
  {
    ...
    sales: 342,
    status: 1, // 库存紧张
    image: 'https://img.alicdn.com/imgextra/i1/2206686532409/O1CN01sC2ylg1TfMrQFKdnK_!!2206686532409-0-sm.jpg',
  ...
  },
  {
    ...
    sales: 109,
    status: 2, // 已售罄
    image: 'https://img.alicdn.com/imgextra/i1/2206686532409/O1CN01y8do7I1TfMrUFtQYq_!!2206686532409-0-sm.jpg',
  ...
  },
  {
    ...
    sales: 85,
    status: 3, // 已下架
    image: 'https://img.alicdn.com/imgextra/i4/2206686532409/O1CN01xK3XrJ1TfMrYtqPTW_!!2206686532409-0-sm.jpg',
  ...
  },
  {
    ...
    sales: 0,
    status: 4, // 审核中
    image: 'https://img.alicdn.com/imgextra/i3/2206686532409/O1CN01iMKbSD1TfMrW9JIpN_!!2206686532409-0-sm.jpg',
  ...
  },
  {
    ...
    sales: 47,
    status: 0, // 正常
    image: 'https://img.alicdn.com/imgextra/i2/2206686532409/O1CN01zLzcpT1TfMrQFKXAU_!!2206686532409-0-sm.jpg',
    createTime: '2023-10-06 10:10:00'
  },
  {
    id: '1007',
    name: '智能手表',
    ...
    sales: 68,
    status: 0, // 正常
    image: 'https://img.alicdn.com/imgextra/i3/2206686532409/O1CN018v8tMX1TfMrXdNQ91_!!2206686532409-0-sm.jpg',
    createTime: '2023-10-07 13:40:00'
  },
  {
    id: '1008',
    name: '时尚背包',
    ...
    sales: 93,
    status: 1, // 库存紧张
    image: 'https://img.alicdn.com/imgextra/i1/2206686532409/O1CN01EogOJG1TfMrSLWwPX_!!2206686532409-0-sm.jpg',
    createTime: '2023-10-08 15:25:00'
  },
  {
    id: '1009',
    name: '精品围巾',
    ...
    sales: 125,
    status: 2, // 已售罄
    image: 'https://img.alicdn.com/imgextra/i2/2206686532409/O1CN01LR2oqj1TfMrZ74uPc_!!2206686532409-0-sm.jpg',
    createTime: '2023-10-09 17:50:00'
  },
  {
    id: '1010',
    name: '高端化妆品套装',
    ...
    sales: 36,
    status: 3, // 已下架
    image: 'https://img.alicdn.com/imgextra/i3/2206686532409/O1CN01LkNNmo1TfMrXdMHp7_!!2206686532409-0-sm.jpg',
    createTime: '2023-10-10 09:05:00'
  }
];
...
Page({
  ...
  // 使用模拟数据
  useMockData: function(loadMore = false) {
    // 根据当前标签页筛选模拟数据
    ...
    if (tabIndex === 0) {
      ...
      filteredMockData = mockProducts.filter(item => (item.status === 0 || item.status === 1) && item.stock > 0);
    } else if (tabIndex === 1) {
      // 已售罄：状态为2(已售罄)或库存为0但状态不是已下架(3)或审核中(4)
      filteredMockData = mockProducts.filter(item => item.status === 2 || (item.stock === 0 && item.status !== 3 && item.status !== 4));
    } else if (tabIndex === 2) {
      // 已下架：状态为3(已下架)
      filteredMockData = mockProducts.filter(item => item.status === 3);
    } else if (tabIndex === 3) {
      // 审核中：状态为4(审核中)
      filteredMockData = mockProducts.filter(item => item.status === 4);
    }
    ...
    if (loadMore) {
      // 加载更多，追加数据
      displayData = [...this.data.displayProducts, ...filteredMockData];
    } else {
      // 首次加载，直接使用筛选后的模拟数据
      displayData = filteredMockData;
    }
    
    // 更新数据
    this.setData({
      products: mockProducts,
      filteredProducts: filteredMockData,
      displayProducts: displayData,
      hasMoreData: false, // 模拟数据没有更多数据
      isLoading: false,
      isLoadingMore: false,
      tabCounts: {
        onSale: onSaleCount,
